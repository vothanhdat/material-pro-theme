...
class SectionProducts extends React.Component {
  ...
  onChangeSlide() {
    if (this.refs.NoUiSlider) {
      ...
      newArray[0] = Number(newArray[0].slice(0, 3));
      newArray[1] = Number(newArray[1].slice(0, 3));
      let currencyLow = this.refs.priceLow.dataset.currency;
      let currencyHigh = this.refs.priceLow.dataset.currency;
      this.refs.priceLow.innerHTML = currencyLow + newArray[0];
      this.refs.priceHigh.innerHTML = currencyHigh + newArray[1];
    }
  }
                    ...
                    collapses={[
                      {
                        ...
                        content: (
                          <CardBody className={classes.cardBodyRefine}>
                            ...
                            <div className="slider slider-rose">
                              <Nouislider
              ...
              <GridContainer>
                  ...
                  <Card plain product>
                    ...
                    <CardFooter plain className={classes.justifyContentBetween}>
                      <div className={classes.priceContainer}>
                        <span className={classes.price}> Γé¼800</span>
                      </div>
                      <Tooltip
                        id="tooltip-top"
                ...
                <GridItem md={4} sm={4}>
                  <Card plain product>
                    ...
                    <CardFooter plain className={classes.justifyContentBetween}>
                      <div className={classes.priceContainer}>
                        <span className={classes.price}> Γé¼555</span>
                      </div>
                      <Tooltip
                        id="tooltip-top"
                ...
                <GridItem md={4} sm={4}>
                  <Card plain product>
                    ...
                    <CardFooter plain className={classes.justifyContentBetween}>
                      <div className={classes.priceContainer}>
                        <span className={classes.price}> Γé¼879</span>
                      </div>
                      <Tooltip
                        id="tooltip-top"
                        title="Save to Wishlist"
                ...
                <GridItem md={4} sm={4}>
                  <Card plain product>
                    ...
                    <CardFooter plain className={classes.justifyContentBetween}>
                      <div className={classes.priceContainer}>
                        <span className={classes.price}> Γé¼680</span>
                      </div>
                      <Tooltip
                        id="tooltip-top"
                        title="Save to Wishlist"
                ...
                <GridItem md={4} sm={4}>
                  <Card plain product>
                    ...
                    <CardFooter plain className={classes.justifyContentBetween}>
                      <div className={classes.priceContainer}>
                        <span className={classes.price}> Γé¼725</span>
                      </div>
                      <Tooltip
                        id="tooltip-top"
                        title="Saved to Wishlist"
                ...
                <GridItem md={4} sm={4}>
                  <Card plain product>
                    ...
                    <CardFooter plain className={classes.justifyContentBetween}>
                      <div className={classes.priceContainer}>
                        <span className={classes.price}> Γé¼699</span>
                      </div>
                      <Tooltip
                        id="tooltip-top"
                        title="Save to Wishlist"
...
// WEBPACK FOOTER //
// ./src/views/EcommercePage/Sections/SectionProducts.jsx