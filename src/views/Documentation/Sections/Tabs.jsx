        ...
        tabs={[
          {
            ...
            tabContent: (
              <p className={classes.textCenter}>
                I think thatΓÇÖs a responsibility that I have, to push
                possibilities, to show people, this is the level that
                things could be at. So when you get something that has
                the name Kanye West on it, itΓÇÖs supposed to be pushing
          ...
          },
          {
            ...
            tabContent: (
              <p className={classes.textCenter}>
                ...
                nucleus. I think thatΓÇÖs a responsibility that I have,
          ...
          },
          {
            ...
            tabContent: (
              <p className={classes.textCenter}>
                think thatΓÇÖs a responsibility that I have, to push
                possibilities, to show people, this is the level that
                things could be at. So when you get something that has
                the name Kanye West on it, itΓÇÖs supposed to be pushing
                the furthest possibilities. I will be the leader of a
          ...
          tabs={[
            {
              ...
              tabContent: (
                <p className={classes.textCenter}>
                  ...
                  West on it, itΓÇÖs supposed to be pushing the furthest
            ...
            },
            {
              ...
              tabContent: (
                <p className={classes.textCenter}>
                  ...
                  being worth billions of dollars, because I got the answers. I
                  understand culture. I am the nucleus. I think thatΓÇÖs a
...
// WEBPACK FOOTER //
// ./src/views/Documentation/Sections/Tabs.jsx