          ...
          <div id="select">
            <GridContainer>
              ...
              <GridItem xs={12} sm={4} md={6}>
                ...
                <GridContainer>
                  <GridItem xs={12} sm={12} md={8} lg={6} className={`${classes.displayDivBlock}`}>
                    <CustomDropdown
                  ...
                  <GridItem xs={12} sm={12} md={8} lg={6}
                    className={`${classes.displayDivBlock}`}>
                    <CustomDropdown
                      dropup
                  ...
                  <GridItem
                    ...
                    md={8}
                    lg={6}
                    className={`${classes.mlAuto} ${classes.mrAuto} ${classes.displayDivBlock}`}
                  >
                    <CustomDropdown
                      dropdownHeader="Dropdown header"
                      buttonText="Dropdown"
...
// WEBPACK FOOTER //
// ./src/views/ComponentsPage/Sections/SectionBasics.jsx