            ...
            <GridItem xs={12} sm={4} md={4}>
              <InfoArea
                ...
                description={
                  <span>
                    <p>
                      The moment you use Material Kit, you know youΓÇÖve never
          ...
          <GridContainer>
            ...
            <GridItem xs={12} sm={6} md={6}>
              ...
              <InfoArea
                ...
                description="The moment you use Material Kit, you know youΓÇÖve never felt anything like it. With a single use, this powerfull UI Kit lets you do more than ever before."
                iconColor="primary"
              />
              <InfoArea
                className={classes.infoArea}
...
// WEBPACK FOOTER //
// ./src/views/SectionsPage/Sections/SectionFeatures.jsx