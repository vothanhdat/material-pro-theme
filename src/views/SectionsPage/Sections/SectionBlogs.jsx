                ...
                <GridContainer>
                  ...
                  <GridItem xs={12} sm={7} md={7}>
                    ...
                    <p className={classes.description1}>
                      ...
                      boxed software company selling licenses. Today, itΓÇÖs
                      moving to a subscription model. Yet its own business model
                      disruption is only part of the story ΓÇö andΓÇª
                      <a href="#pablo" onClick={e => e.preventDefault()}>
                        {" "}
                        Read More{" "}
                      </a>
              ...
              <Card plain blog className={classes.card4}>
                ...
                <CardBody plain>
                  ...
                  <h5 className={classes.description}>
                    ...
                    Kanye I love Rick OwensΓÇÖ bed design but the back is too high
                    for the beams and angle of the ceiling I also wanted to
                    point out that itΓÇÖs the first album to go number 1 off of
                    streaming...
                  </h5>
...
// WEBPACK FOOTER //
// ./src/views/SectionsPage/Sections/SectionBlogs.jsx